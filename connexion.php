      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav w-100 justify-content-end">
            ...
            <?php } else { ?>
            <li class="nav-item d-flex justify-content-end">
              <a class="nav-link couleur-menu" href="connexion.php">Se connecter</a>
            </li>
            <li class="nav-item d-flex justify-content-end">
      ...
      <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
        <div class="card border border-light-subtle rounded-3 shadow-sm">
          <div class="card-body p-3 p-md-4 p-xl-5">
            ...
            <h2 class="fs-6 fw-normal text-center text-secondary mb-4">Completez les champs pour vous connecter :</h2>
              ...
              <div class="row gy-2 overflow-hidden">
                ...
                <div class="col-12">
                  <div class="d-grid my-3">
                    <button class="btn mybtn mybtn:hover btn-lg btn-lg" type="submit">Valider</button>
                  </div>
                </div>
                <div class="col-12">
                  <p class="m-0 text-secondary text-center">Pas de compte ?     <a href="inscription.php" class="link-primary text-decoration-none">Inscrivez vous ici</a></p>
                </div>
              </div>
            </form>
          </div>
