...
<main class="container w-70 text-center"> 



 <section class="row align-item-center justify-content-center justify-content-evenly gx-0 gx-sm-5 ">
   <!-- <div class="text-center"> -->
      
   <button type="button" class="btn mybtn mybtn:hover mt-4 w-50 " data-bs-toggle="modal" data-bs-target="#createArticleModal">
